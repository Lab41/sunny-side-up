...
from accuracy_cython import compute_rank_violations, get_closest
...
def finish_analogy(analogies, word_vectors, no_threads=1):
    """
    Return the answer to the analogy based on this corpus
